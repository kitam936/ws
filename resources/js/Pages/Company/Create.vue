...
const form = useForm({
    co_id: page.props.old?.co_id ?? "",
    co_name: page.props.old?.co_name ?? null,
    co_info: page.props.old?.co_info ?? null,
    pic_id: page.props.old?.pic_id ?? "",
});
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">会社登録</h2>
            <div class="flex mt-4">
                <div class="">
                    <button
                        type="button"
